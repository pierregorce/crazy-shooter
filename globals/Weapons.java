...
public enum Weapons
{
	...
	PLAYER_MINIGUN("MINIGUN", 0.06f, false, 9999, false, 8, R.c().player_weapons[7], Projectiles.PLAYER_MINIGUN),
	PLAYER_GRENADE_LUNCHER("GRENADE THROWER", 0.6f, false, 12800, false, 15, R.c().player_weapons[8], Projectiles.PLAYER_GRENADE_LUNCHER),
	PLAYER_SNIPER("RAIL GUN", 0.3f, false, 15000, false, 0, R.c().player_weapons[9], Projectiles.PLAYER_RAILGUN),
