...
public enum Projectiles
{
	...
	PLAYER_PUMP(7, 2, 20, 4, new Vector2(30, 50), 1000, 25, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w2_projectile),
	...
	PLAYER_MACHINE(7, 2, 20, 1, new Vector2(70, 40), 1000, 50, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w4_projectile),
	...
	PLAYER_GRENADE_LUNCHER(15, 2, 20, 1, new Vector2(50, 50), 99999, 5, true, new ProjectileComportements().new Physic_Grenade(25, 2, 15, 2), false, R.c().weapons_w8_projectile),
	PLAYER_GRENADE_EXPLOSION(9, 2, 20, 4, new Vector2(0, 0), 99999, 40, true, new ProjectileComportements().new Explosion(60, 60), true, R.c().fx_pop),
