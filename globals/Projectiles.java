...
public enum Projectiles
{
	...
	PLAYER_ROCKET_LUNCHER(12, 2, 15, 1, new Vector2(37 * Player.heightCoef, 15 * 4 * Player.heightCoef), 1000, 5, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w10_projectile),
	...
	ENEMY_KING_WIZARD(15, 2, 20, 1, new Vector2(2, 2), 1000, 5, true, new ProjectileComportements().new Target_Player_Action(), false, R.c().enemy_kingWizard_bullet),
