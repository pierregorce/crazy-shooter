...
public enum Projectiles
{
	...
	PLAYER_LIGHTING_GUN(12, 2, 20, 1, new Vector2(90, 56 * Player.heightCoef), 600, 5, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w0_projectile),
	...
	ENEMY_KNIGHT(15, 2, 20, 3, new Vector2(30, 16), 1000, 50, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w0_projectile),
	...
	ENEMY_KING_WIZARD(15, 2, 20, 1, new Vector2(2, 2), 1000, 50, true, new ProjectileComportements().new Target_Player_Action(), false, R.c().enemy_fantomas_bullet),
