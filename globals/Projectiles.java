...
public enum Projectiles
{
	...
	PLAYER_FLAME_THROWER(5, 2, 15, 4, new Vector2(75, 23), 1000, 5, true, new ProjectileComportements().new Flame(), false, R.c().weapons_w5_projectile),
	PLAYER_LASER(4, 2, 25, 2, new Vector2(30, 10), 600, 5, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w0_projectile),
	PLAYER_MINIGUN(5, 2, 20, 2, new Vector2(70, 20), 1000, 5, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w7_projectile),
	...
	PLAYER_RAILGUN(12, 2, 25, 1, new Vector2(41 * Player.heightCoef, 17 * 4 * Player.heightCoef), 1000, 5, false, new ProjectileComportements().new Straight_Piercing(), false, R.c().weapons_w9_projectile),
	...
	PLAYER_LIGHTING_GUN(15, 4, 20, 4, new Vector2(90, 57 * Player.heightCoef), 450, 10, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w0_projectile),
	...
	ENEMY_METEORE(35, 2, 20, 1, new Vector2(2, 2), 2000, 0, true, new ProjectileComportements().new Fall_Meteore(5, 2, 8, 5), false, R.c().enemy_meteor),
