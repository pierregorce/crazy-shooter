...
public enum Projectiles
{
	...
	PLAYER_DUAL_GUN(12, 2, 20, 1, new Vector2(30, 50), 1000, 50, true, new ProjectileComportements().new Straight_Inverted(), false, R.c().weapons_w1_projectile),
	PLAYER_PUMP(7, 2, 20, 4, new Vector2(30, 50), 1000, 50, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w2_projectile),
	...
	PLAYER_ROCKET_LUNCHER(0, 0, 0, 1, new Vector2(37 * Player.heightCoef, 15 * 4 * Player.heightCoef), 1000, 5, true, new ProjectileComportements().new Rocket(), false, R.c().weapons_w10_projectile),
	PLAYER_ROCKET_SIMPLE(19, 5, 15, 1, new Vector2(37 * Player.heightCoef, 15 * 4 * Player.heightCoef), 1000, 5, true, new ProjectileComportements().new SimpleRocket(), false, R.c().weapons_w10_projectile),
	PLAYER_LIGHTING_GUN(10, 2, 20, 1, new Vector2(90, 57 * Player.heightCoef), 450, 5, true, new ProjectileComportements().new Straight(), false, R.c().weapons_w0_projectile),
	ENEMY_WIZARD(10, 2, 20, 1, new Vector2(2, 2), 1000, 0, true, new ProjectileComportements().new Straight(), false, R.c().enemy_wizard_bullet),
	ENEMY_LIMON(12, 2, 20, 3, new Vector2(2, 2), 1000, 0, true, new ProjectileComportements().new Straight(), false, R.c().enemy_limon_bullet),
	...
	ENEMY_FANTOMAS(15, 2, 20, 1, new Vector2(2, 2), 1000, 0, true, new ProjectileComportements().new Target_Player_Action(), false, R.c().enemy_fantomas_bullet),
	...
	ENEMY_POT(10, 2, 20, 3, new Vector2(50, 50), 1000, 0, true, new ProjectileComportements().new Physic(19, 7, 34, 2), false, R.c().enemy_wasp_bullet),
	...
	ENEMY_METEORE(15, 2, 20, 1, new Vector2(2, 2), 2000, 0, true, new ProjectileComportements().new Fall_Meteore(5, 2, 8, 5), false, R.c().enemy_meteor),
	...
	TAPIS(10, 1, 20, 15, new Vector2(2, 2), 99999, 0, false, new ProjectileComportements().new PhysicMud(13, 5, 22, 5, 1), false, R.c().irregularParticles);
